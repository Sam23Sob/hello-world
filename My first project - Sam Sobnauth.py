...
root = tkinter.Tk()
#set the title.
root.title("Guess the colours -by Sam Sobnauth")
...
instructions = tkinter.Label(root, text="TYPE THE COLOR OF THE WORDS",bg=('lightseagreen'), font=('Jokerman', 60))
instructions.pack()

myscore = tkinter.Label(root, text="My owner's score it's 10! Can you beat him?",bg=('lightseagreen'), font=('Sketch Gothic School', 60))
myscore.pack()


#add a score label.
scoreLabel = tkinter.Label(root, text="Press ENTER to PLAY",bg=('lightseagreen'), font=('Jokerman', 48))
scoreLabel.pack()

#add a time left label.
timeLabel = tkinter.Label(root, text="Time left: " + str(timeleft),bg=('lightseagreen'), font=('Agency FB', 36))
timeLabel.pack()

#add a label for displaying the colours.
label = tkinter.Label(root,bg=('lightseagreen'), font=('Jokerman', 60))
label.pack()
